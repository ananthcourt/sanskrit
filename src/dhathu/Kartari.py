...
file_name_lst = ["dhatuforms_vidyut_nich_kartari","dhatuforms_vidyut_san_kartari","dhatuforms_vidyut_shuddha_kartari","dhatuforms_vidyut_yang_kartari","dhatuforms_vidyut_yangluk_kartari"]
...
def kartari_to_excel(file_path):
...
output_file = "/Users/srihitagollapudi/Documents/Sanskrit_project/sanskrit/data/dhathu/excel_books/kartari.xlsx"
with pd.ExcelWriter(output_file, engine="openpyxl") as writer:
    for file_name in file_name_lst:
        path = file_path + file_name + ".txt"
        df = kartari_to_excel(path)
